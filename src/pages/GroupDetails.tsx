            ...
            <CardContent>
              ...
              <div className="mb-6 p-6 bg-muted/50 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <p className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span><strong>Siga as políticas oficiais:</strong> Todos os grupos devem estar em conformidade com os Termos de Serviço do WhatsApp, as Políticas do Google AdSense e a legislação brasileira aplicável.</span>
                  </p>
                  <p className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
